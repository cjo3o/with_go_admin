...
function ApplicationList() {
  ...
  const counts = {
    ...
    delivery: combinedData.filter(
      (d) => d.division === "배송" && d.processingStatus !== "취소"
    ).length,
    storage: combinedData.filter(
      (d) => d.division === "보관" && d.processingStatus !== "취소"
    ).length,
                    ...
                    ? [
                        {
                          ...
                          children: (
                            <ExcelTable
                              showCheckbox={false}
                              combinedSearchData={getFilteredResults("all").map(
                        ...
                        },
                        {
                          ...
                          children: (
                            <ExcelTable
                              showCheckbox={false}
                              combinedSearchData={getFilteredResults(
                                "delivery"
                              ).map((item, idx) => ({
                                ...item,
                                number: idx + 1,
